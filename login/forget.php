...
<body>
    <div id="wrapper">
        ...
        <?php        //nhúng thư viện vào để dùng
        require path('libs/PHPMailer-master/src/PHPMailer.php');
        require path('libs/PHPMailer-master/src/SMTP.php');
        require path('libs/PHPMailer-master/src/Exception.php');
